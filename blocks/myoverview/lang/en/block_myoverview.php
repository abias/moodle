...
$string['displaycourseimages_desc'] = 'Display the course image (respectively the course pattern if there is no course image uploaded to a course or if course images are disabled globally) on the card and summary layout.';
