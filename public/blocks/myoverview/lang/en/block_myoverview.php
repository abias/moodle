...
$string['availablesortings'] = 'Available sortings';
$string['availablesortings_desc'] = 'Course sortings which are available for selection by users. If none are selected, sorting by course name will be used as default.';
$string['card'] = 'Card';
$string['cards'] = 'Cards';
...
$string['defaultsorting'] = 'Default sorting';
$string['defaultsorting_desc'] = 'Set the default sorting method that will be used until the user makes his first sorting choice.';
...
$string['sortingsettings'] = 'More sorting settings';
$string['sortingsettings_desc'] = 'Specific settings which allow you to control the sorting behaviour';
