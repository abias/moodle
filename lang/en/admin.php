...
$string['confignotifyloginthreshold'] = 'If notifications about failed logins are active, how many failed login attempts by {$a} is it worth notifying about?';
...
$string['notifyloginthreshold'] = 'Threshold for email notifications (by {$a})';
...
$string['oneip'] = 'one IP address';
$string['oneuser'] = 'one user';
